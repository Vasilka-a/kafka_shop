package example.notification.kafka.config;
...
public class NotificationConsumerConfig {
    ...
    public ConsumerFactory<String, ShippingMessage> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ShippingMessage.class.getName());
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ShippingMessage> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ShippingMessage> factory = new ConcurrentKafkaListenerContainerFactory<>();
